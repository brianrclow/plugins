...
Advanced video player for NativeScript iOS and Android.
...
For a 100% NativeScript plugin use the [@nativescript/video](https://github.com/NativeScript/plugins/tree/main/packages/video).
...
<Page xmlns="http://schemas.nativescript.org/tns.xsd"
      xmlns:exoplayer="@nativescript/video-advanced">
        <StackLayout>
            <exoplayer:Video id="nativeVideoPlayer"
...
import { Video } from '@nativescript/video-advanced';
